...
import com.superidol.swing.ButtonCustom;
import com.superidol.swing.MenuItem;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void createButtonMenu() {
        ...
        cmdMenu.setIcon(new ImageIcon(getClass().getResource("/com/superidol/icon/menu.png")));
        cmdMenu.setBorder(new EmptyBorder(5, 12, 5, 12));
    }

    private void createButtonLogout() {
        cmdLogOut = new ButtonCustom();
        cmdLogOut.setIcon(new ImageIcon(getClass().getResource("/com/superidol/icon/exit.png")));
    }
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, Color.decode("#ff6b81"), 0, getHeight(), Color.decode("#FDA7DF"));
        g2.setPaint(gra);
