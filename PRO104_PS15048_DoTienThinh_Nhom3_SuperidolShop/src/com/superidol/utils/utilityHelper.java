...
public class utilityHelper {
    ...
    public static boolean checkMaNV(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            MsgBox.alert(txt.getRootPane()," phải có 1-15 kí tự\nchữ hoa, thường không dấu hoặc số.");
            return false;
        }
    }
    ...
    public static boolean checkMaCD(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane()," phải có đúng 5 kí tự\nchữ thường, chữ hoa hoặc số");
            return false;
        }
    }
    ...
    public static boolean checkPass(JPasswordField txt) {
        ...
        if (txt.getPassword().length > 2 && txt.getPassword().length < 17) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane()," phải có từ 3-16 kí tự.");
            return false;
        }
    }
...
//        } else {
//            txt.setBackground(pink);
//            MsgBox.alert(txt.getRootPane()," không đúng định dạng Date.");
//            return false;
//        }
        if (isValidDate(id)) {
            return true;
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane()," không đúng định dạng dd/MM/yyyy");
            return false;
        }
    }
    
     public static boolean checkDate(JDateChooser date) {
        date.setBackground(white);
        String id = date.getDateFormatString();
//        String rgx = "^(?:(?:31(\\/|-|\\.)(?:0?[13578]|1[02]))\\1|(?:(?:29|30)(\\/|-|\\.)(?:0?[1,3-9]|1[0-2])\\2))(?:(?:1[6-9]|[2-9]\\d)?\\d{2})$|^(?:29(\\/|-|\\.)0?2\\3(?:(?:(?:1[6-9]|[2-9]\\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\\d|2[0-8])(\\/|-|\\.)(?:(?:0?[1-9])|(?:1[0-2]))\\4(?:(?:1[6-9]|[2-9]\\d)?\\d{2})$";
//        if (id.matches(rgx)) {
//            return true;
//        } else {
...
//        }
        if (isValidDate(id)) {
            ...
            date.setBackground(pink);
            MsgBox.alert(date.getRootPane()," không đúng định dạng dd/MM/yyyy");
            return false;
        }
    }
    ...
    public static boolean checkName(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane()," phải là tên tiếng việt hoặc không đấu\ntừ 3-25 kí tự");
            return false;
        }
    }
    ...
    public static boolean checkTenCD(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane()," phải từ 3-50 kí tự.");
            return false;
        }
    }
    ...
    public static boolean checkMoTaCD(JTextArea txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(),"ghi chú tối đa 100 kí tự!");
            return false;
        }
    }
    public static boolean checkMoTaCD(JTextPane txt) {
        txt.setBackground(white);
        String id = txt.getText();
        String rgx = ".{0,100}";
        if (id.matches(rgx)) {
    ...
    public static boolean checkSDT(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane()," phải gồm 10 số\nđúng các đầu số của nhà mạng.");
            return false;
        }
    }
    ...
    public static boolean checkEmail(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane()," không đúng định dạng");
            return false;
        }
    }
    ...
    public static boolean checkThoiLuong(JTextField txt) {
        ...
        try {
            ...
            if (hour >= 0) {
                ...
                txt.setBackground(pink);
                MsgBox.alert(txt.getRootPane()," phải lớn hơn bằng 0.");
                return false;
            }
        } catch (NumberFormatException e) {
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane()," phải là số nguyên.");
            return false;
        }
    }
    ...
    public static boolean checkHocPhi(JTextField txt) {
        ...
        try {
            ...
            if (hp >= 0) {
                ...
                txt.setBackground(pink);
                MsgBox.alert(txt.getRootPane()," phải là lớn hơn bằng 0.");
                return false;
            }
        } catch (NumberFormatException e) {
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane()," phải là số thực.");
            return false;
        }
    }
    ...
    public static boolean checkDiem(JTextField txt) {
        ...
        try {
            ...
            if ((hp >= 0 && hp <= 10) || hp == -1) {
                ...
                txt.setBackground(pink);
                MsgBox.alert(txt.getRootPane(),"Điểm phải là trong khoảng 0-10 hoặc chưa nhập (-1).");
                return false;
            }
        } catch (NumberFormatException e) {
            txt.setBackground(pink);
    ...
    public static boolean checkNullText(JTextField txt) {
     ...
     public static boolean checkNullText(JDateChooser date) {
        date.setBackground(white);
    ...
    public static boolean checkNullText(JTextPane txtp) {
        txtp.setBackground(white);
        if (txtp.getText().trim().length() > 0) {
            return true;
        } else {
            txtp.setBackground(pink);
            MsgBox.alert(txtp.getRootPane(), "Không được để trống địa chỉ ");
            return false;
        }
    }
    ...
    public static boolean checkDonGiaSp(JTextField txt) {
        txt.setBackground(white);
        try {
            float dongia = Float.parseFloat(txt.getText());
            if (dongia > 0) {
                return true;
            } else {
                txt.setBackground(pink);
                MsgBox.alert(txt.getRootPane()," phải là lớn hơn 0.");
                return false;
            }
        } catch (NumberFormatException e) {
            txt.setBackground(pink);
    ...
    public static boolean checkSoLuongSp(JTextField txt) {
        txt.setBackground(white);
        try {
            ...
            if (soluong > 0) {
                ...
                txt.setBackground(pink);
                MsgBox.alert(txt.getRootPane()," phải lớn hơn  0.");
                return false;
            }
        } catch (NumberFormatException e) {
            txt.setBackground(pink);
